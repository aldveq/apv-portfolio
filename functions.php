...
add_action( 'after_setup_theme', 'apv_portfolio_setup' );
 ...
 */
function apv_portfolio_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'apv_portfolio_content_width', 640 );
}
add_action( 'after_setup_theme', 'apv_portfolio_content_width', 0 );
 ...
 */
function apv_portfolio_widgets_init() {
	register_sidebar(
		array(
...
add_action( 'widgets_init', 'apv_portfolio_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function apv_portfolio_scripts() {
...
add_action( 'wp_enqueue_scripts', 'apv_portfolio_scripts' );
